...
class Osobnik:
    ...
    def __init__(self, n_tasks, chromosom=None):
    ...
    def krzyzowanie(self, drugi: 'Osobnik') -> 'Osobnik':
        ...
        return Osobnik(n_tasks=self.n_tasks, chromosom=hstack((self.chromosom[:punkt_przedzialu], drugi.chromosom[punkt_przedzialu:])))
